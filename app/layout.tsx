...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "تيكس", "تكس", "tix", "Tix", "TIX", "منصة تيكس", "موقع تيكس", "شركة تيكس", "شركه تيكس", "tix egypt", "تيكس مصر", "موقع تيكس مصر",
    // الشرقية والزقازيق
    "تيكس الشرقية", "تيكس الشرقيه", "الشرقية", "الشرقيه", "تيكس الزقازيق", "الزقازيق", "موقع تيكس الزقازيق", "شركة تيكس الزقازيق", "تسوق اونلاين الشرقية", "تسوق اونلاين الزقازيق", "محافظة الشرقية",
  ...
  "@graph": [
    {
      ...
      name: "تيكس",
      alternateName: ["tix", "Tix", "TIX", "تكس", "منصة تيكس", "موقع تيكس", "شركة تيكس", "شركه تيكس", "تيكس مصر", "موقع تيكس مصر", "تيكس الشرقية", "تيكس الزقازيق", "tix egypt"],
      url: "https://tix-eg.com",
      ...
      areaServed: [
        ...
        { "@type": "AdministrativeArea", name: "الشرقية", alternateName: "Sharqia" },
        { "@type": "City", name: "الزقازيق", alternateName: "Zagazig" },
      ],
    ...
    },
    {
      ...
      url: "https://tix-eg.com",
      name: "تيكس tix",
      alternateName: ["tix", "Tix", "TIX", "تيكس", "موقع تيكس", "تيكس مصر", "تيكس الشرقية", "تيكس الزقازيق"],
      inLanguage: "ar-EG",
